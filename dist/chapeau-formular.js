...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var v = function() {
      function u(c) {
        ...
        var ke = Et.querySelector(".w-slider");
        if (!ke)
          throw new Error("No slider found inside the form, please add one.");
        this.slider = ke;
        var bn = ke.querySelector(".w-slider-mask");
        if (!bn)
          throw new Error("No mask found inside the slider!");
        this.mask = bn, this.steps = ke.querySelectorAll(".w-slide");
        var On = ke.querySelector(".w-slider-arrow-right");
        if (!On)
          throw new Error("No right arrow found inside the slider!");
        this.rightArrow = On;
        var Dn = ke.querySelector(".w-slider-arrow-left");
        if (!Dn)
          throw new Error("No left arrow found inside the slider!");
        this.leftArrow = Dn, this.sliderDots = ke.querySelectorAll(".w-slider-dot"), this.navLinks = document.querySelectorAll("[data-msf-nav]"), this.nextText = ve || this.next.textContent || "Next", this.backText = z, this.submitText = this.submitButton.value, this.warningClass = we, this.alertText = R, this.alertInteraction = (E = this.alert) === null || E === void 0 ? void 0 : E.querySelector('[data-msf="alert"]'), this.scrollTopOnStepChange = ot, this.hiddeButtonsOnSubmit = le, this.sendHiddenForm = Se, this.hiddenFormStep = me >= 1 ? me : 1, this.inputs = this.getInputs();
      }
    ...
    var C = typeof r == "object" && r && r.Object === Object && r, $ = typeof self == "object" && self && self.Object === Object && self, X = C || $ || Function("return this")(), Ue = function() {
      return X.Date.now();
    }, Nt = /\s/;
    function Oe(u) {
    ...
    function Os(u, c, E) {
      ...
      return c = pn(c) || 0, M(E) && (j = !!E.leading, x = (le = "maxWait" in E) ? ys(pn(E.maxWait) || 0, c) : x, Q = "trailing" in E ? !!E.trailing : Q), ot.cancel = function() {
        ...
        return k === void 0 ? z : it(Ue());
      }, ot;
    }
    y.default = Os;
    var Ae = {};
    Object.defineProperty(Ae, "__esModule", { value: !0 });
    var nt = (je = void 0, Le = Ae.isFormElement = je, ft = Ae.throwError = Le, Ae.isVisible = ft);
...
window.AsyncForm = Be;
document.addEventListener("DOMContentLoaded", () => {
  Array.from(document.querySelectorAll("[c-async-form]")).forEach((e) => new Be(e));
});
document.querySelector("[c-fileupload]") && Promise.resolve().then(() => Wl);
/*!
 * FilePond 4.30.6
 * Licensed under MIT, https://opensource.org/licenses/MIT/
 * Please visit https://pqina.nl/filepond/ for details.
 */
const Bs = (e) => e instanceof HTMLElement, xs = (e, t = [], n = []) => {
  const r = {
    ...e
  }, s = [], o = [], i = () => ({ ...r }), l = () => {
    const p = [...s];
  ...
  e.setAttribute(t, n);
}, ks = "http://www.w3.org/2000/svg", Vs = ["svg", "path"], vn = (e) => Vs.includes(e), Rt = (e, t, n = {}) => {
  typeof t == "object" && (n = t, t = null);
  const r = vn(e) ? document.createElementNS(ks, e) : document.createElement(e);
  return t && (vn(e) ? re(r, "class", t) : r.className = t), Z(n, (s, o) => {
    re(r, s, o);
  }), r;
}, qs = (e) => (t, n) => {
  typeof n < "u" && e.children[n] ? e.insertBefore(t, e.children[n]) : e.appendChild(t);
}, Hs = (e, t) => (n, r) => (typeof r < "u" ? t.splice(r, 0, n) : t.push(n), n), Ys = (e, t) => (n) => (t.splice(t.indexOf(n), 1), n.element.parentNode && e.removeChild(n.element), n), zs = typeof window < "u" && typeof window.document < "u", _r = () => zs, Ws = _r() ? Rt("svg") : {}, $s = "children" in Ws ? (e) => e.children.length : (e) => e.childNodes.length, gr = (e, t, n, r) => {
...
}, Ve = (e) => typeof e == "number", Xs = (e, t, n, r = 1e-3) => Math.abs(e - t) < r && Math.abs(n) < r, js = (
  // default options
  ({ stiffness: e = 0.5, damping: t = 0.75, mass: n = 10 } = {}) => {
    ...
    const f = Fe({
      interpolate: (d, m) => {
        ...
        const h = -(s - r) * e;
        o += h / n, s += o, o *= t, Xs(s, r, o) || m ? (s = r, o = 0, i = !0, f.onupdate(s), f.oncomplete(s)) : f.onupdate(s);
      },
      target: {
        set: (d) => {
          if (Ve(d) && !Ve(s) && (s = d), r === null && (r = d, s = d), r = d, s === r || typeof r > "u") {
...
), Qs = (e) => e < 0.5 ? 2 * e * e : -1 + (4 - 2 * e) * e, Zs = (
  // default values
  ({ duration: e = 500, easing: t = Qs, delay: n = 0 } = {}) => {
...
}, Js = ({ mixinConfig: e, viewProps: t, viewInternalAPI: n, viewExternalAPI: r }) => {
  const s = { ...t }, o = [];
  return Z(e, (i, l) => {
    const a = Ks(l);
    if (!a)
  ...
  const i = [], l = ei(o.element), a = ti(o.element);
  return r.on = (f, d) => {
    i.push({
      type: f,
      fn: d
...
}, ri = ({ mixinConfig: e, viewProps: t, viewExternalAPI: n }) => {
  Kt(e, n, t);
}, de = (e) => e != null, si = {
  opacity: 1,
  scaleX: 1,
  ...
  originX: 0,
  originY: 0
}, ii = ({ mixinConfig: e, viewProps: t, viewInternalAPI: n, viewExternalAPI: r, view: s }) => {
  const o = { ...t }, i = {};
  Kt(e, [n, r], t);
  const l = () => [t.translateX || 0, t.translateY || 0], a = () => [t.scaleX || 0, t.scaleY || 0], f = () => s.rect ? gr(s.rect, s.childViews, l(), a()) : null;
  return n.rect = { get: f }, r.rect = { get: f }, e.forEach((d) => {
    t[d] = typeof o[d] > "u" ? si[d] : o[d];
  }), {
    write: () => {
      if (oi(i, t))
        return ai(s.element, t), Object.assign(i, { ...t }), !0;
    },
    destroy: () => {
    }
  };
  ...
  ({
    ...
    const w = [], P = [], F = {}, W = {}, v = [
      ...
      i
      // default destroy
    ], N = () => I, U = () => w.concat(), ie = () => F, b = (H) => (K, Te) => K(H, Te), Y = () => A || (A = gr(O, w, [0, 0], [1, 1]), A), S = () => D, y = () => {
      ...
      appendChildView: Hs(I, w),
      removeChildView: Ys(I, w),
...
}, Mn = (e, t) => t.parentNode.insertBefore(e, t), Cn = (e, t) => t.parentNode.insertBefore(e, t.nextSibling), vt = (e) => Array.isArray(e), Pe = (e) => e == null, ui = (e) => e.trim(), At = (e) => "" + e, di = (e, t = ",") => Pe(e) ? [] : vt(e) ? e : At(e).split(t).map(ui).filter((n) => n.length), Sr = (e) => typeof e == "boolean", Rr = (e) => Sr(e) ? e : e === "true", fe = (e) => typeof e == "string", yr = (e) => Ve(e) ? e : fe(e) ? At(e).replace(/[a-z]+/gi, "") : 0, gt = (e) => parseInt(yr(e), 10), Nn = (e) => parseFloat(yr(e)), tt = (e) => Ve(e) && isFinite(e) && Math.floor(e) === e, Gn = (e, t = 1e3) => {
  if (tt(e))
    return e;
  let n = At(e).trim();
  return /MB$/i.test(n) ? (n = n.replace(/MB$i/, "").trim(), gt(n) * t * t) : /KB/i.test(n) ? (n = n.replace(/KB$i/, "").trim(), gt(n) * t) : gt(n);
}, qe = (e) => typeof e == "function", fi = (e) => {
  ...
  return t.url = fe(e) ? e : e.url || "", t.timeout = e.timeout ? parseInt(e.timeout, 10) : 0, t.headers = e.headers ? e.headers : {}, Z(Fn, (n) => {
    t[n] = pi(n, e[n], Fn[n], t.timeout, t.headers);
  ...
  return o.withCredentials = Rr(o.withCredentials), o;
}, mi = (e) => Ei(e), hi = (e) => e === null, ae = (e) => typeof e == "object" && e !== null, Ti = (e) => ae(e) && fe(e.url) && ae(e.process) && ae(e.revert) && ae(e.restore) && ae(e.fetch), Ht = (e) => vt(e) ? "array" : hi(e) ? "null" : tt(e) ? "int" : /^[0-9]+ ?(?:GB|MB|KB)$/gi.test(e) ? "bytes" : Ti(e) ? "api" : typeof e, Ii = (e) => e.replace(/{\s*'/g, '{"').replace(/'\s*}/g, '"}').replace(/'\s*:/g, '":').replace(/:\s*'/g, ':"').replace(/,\s*'/g, ',"').replace(/'\s*,/g, '",'), _i = {
  array: di,
  boolean: Rr,
  ...
  // options
  options: Ri(e)
}), Lt = (e, t = "-") => e.split(/(?=[A-Z])/).map((n) => n.toLowerCase()).join(t), bi = (e, t) => {
  const n = {};
  return Z(t, (r) => {
    n[r] = {
  ...
  PASTE: 4,
  NONE: 5
}, Jt = () => Math.random().toString(36).substring(2, 11), en = (e, t) => e.splice(t, 1), vi = (e, t) => {
  ...
  const e = [], t = (r, s) => {
    ...
    e.filter((i) => i.event === r).map((i) => i.cb).forEach((i) => vi(() => i(...s), o));
  };
  return {
    fireSync: (r, ...s) => {
      n(r, s, !0);
  ...
  LIMBO: 2,
  LOCAL: 3
}, Dr = (e) => /[^0-9]+/.exec(e), vr = () => Dr(1.1.toLocaleString())[0], wi = () => {
  const e = vr(), t = 1e3.toLocaleString();
  return t !== "1000" ? Dr(t)[0] : e === "." ? "," : ".";
}, g = {
  BOOLEAN: "boolean",
  INT: "int",
  NUMBER: "number",
...
}), $e = (e, t, n) => tn.filter((r) => r.key === e).map((r) => r.cb(t, n)), Pi = (e, t) => tn.push({ key: e, cb: t }), Mi = (e) => Object.assign(Qe, e), yt = () => ({ ...Qe }), Ci = (e) => {
  Z(e, (t, n) => {
    Qe[t] && (Qe[t][0] = br(
      n,
      Qe[t][0],
  ...
  labelDecimalSeparator: [vr(), g.STRING],
  // Default is locale separator
  labelThousandsSeparator: [wi(), g.STRING],
  // Default is locale separator
  labelIdle: [
...
}, He = (e, t) => Pe(t) ? e[0] || null : tt(t) ? e[t] || null : (typeof t == "object" && (t = t.id), e.find((n) => n.id === t) || null), Ar = (e) => {
  if (Pe(e))
    return e;
  if (/:/.test(e)) {
    const t = e.split(":");
...
const Ni = () => {
  ...
  V.PROCESSING_QUEUED,
  V.INIT
], Bi = [V.PROCESSING_COMPLETE], xi = (e) => Gi.includes(e.status), Ui = (e) => Fi.includes(e.status), ki = (e) => Bi.includes(e.status), Bn = (e) => ae(e.options.server) && (ae(e.options.server.process) || qe(e.options.server.process)), Vi = (e) => ({
  GET_STATUS: () => {
    const t = ye(e.items), { EMPTY: n, ERROR: r, BUSY: s, IDLE: o, READY: i } = Lr;
    return t.length === 0 ? n : t.some(xi) ? r : t.some(Ui) ? s : t.some(ki) ? i : o;
  },
  GET_ITEM: (t) => He(e.items, t),
  GET_ACTIVE_ITEM: (t) => He(ye(e.items), t),
  ...
  GET_PANEL_ASPECT_RATIO: () => /circle/.test(e.options.stylePanelLayout) ? 1 : Ar(e.options.stylePanelAspectRatio),
  ...
  SHOULD_UPDATE_FILE_INPUT: () => e.options.storeAsFile && Ni() && !Bn(e),
  IS_ASYNC: () => Bn(e),
  ...
  return n === null || t < n;
}, wr = (e, t, n) => Math.max(Math.min(n, e), t), Hi = (e, t, n) => e.splice(t, 0, n), Yi = (e, t, n) => Pe(t) ? null : typeof n > "u" ? (e.push(t), t) : (n = wr(n, 0, e.length), Hi(e, n, t), t), Yt = (e) => /^\s*data:([a-z]+\/[a-z0-9-+.]+(;[a-z-]+=[a-z0-9-]+)?)?(;base64)?,([a-z0-9!$&',()*+;=\-._~:@\/?%\s]*)\s*$/i.test(
  e
), dt = (e) => `${e}`.split("/").pop().split("?").shift(), Pt = (e) => e.split(".").pop(), zi = (e) => {
  if (typeof e != "string")
    return "";
  const t = e.split("/").pop();
  return /svg/.test(t) ? "svg" : /zip|compressed/.test(t) ? "zip" : /plain/.test(t) ? "txt" : /msword/.test(t) ? "doc" : /[a-z]+/.test(t) ? t === "jpeg" ? "jpg" : t : "";
}, at = (e, t = "") => (t + e).slice(-t.length), Pr = (e = /* @__PURE__ */ new Date()) => `${e.getFullYear()}-${at(e.getMonth() + 1, "00")}-${at(
  e.getDate(),
  "00"
)}_${at(e.getHours(), "00")}-${at(e.getMinutes(), "00")}-${at(
  e.getSeconds(),
  "00"
)}`, Je = (e, t, n = null, r = null) => {
  const s = typeof n == "string" ? e.slice(0, e.size, n) : e.slice(0, e.size, e.type);
  return s.lastModifiedDate = /* @__PURE__ */ new Date(), e._relativePath && (s._relativePath = e._relativePath), fe(t) || (t = Pr()), t && r === null && Pt(t) ? s.name = t : (r = r || zi(s.type), s.name = t + (r ? "." + r : "")), s;
}, Wi = () => window.BlobBuilder = window.BlobBuilder || window.WebKitBlobBuilder || window.MozBlobBuilder || window.MSBlobBuilder, Mr = (e, t) => {
  const n = Wi();
  if (n) {
    const r = new n();
  ...
  for (let s = 0; s < e.length; s++)
    r[s] = e.charCodeAt(s);
  return Mr(n, t);
}, Cr = (e) => (/^data:(.+);/.exec(e) || [])[1] || null, Xi = (e) => e.split(",")[1].replace(/\s/g, ""), ji = (e) => atob(Xi(e)), Qi = (e) => {
  const t = Cr(e), n = ji(e);
  return $i(n, t);
}, Zi = (e, t, n) => Je(Qi(e), t, null, n), Ki = (e) => {
  ...
  return null;
}, eo = (e) => /x-content-transfer-id:/i.test(e) && (e.split(":")[1] || "").trim() || null, nn = (e) => {
  const t = {
    source: null,
    name: null,
    size: null
...
`);
  ...
  const t = {
    ...
    const l = t.source;
    i.fire("init", l), l instanceof File ? i.fire("load", l) : l instanceof Blob ? i.fire("load", Je(l, l.name)) : Yt(l) ? i.fire("load", Zi(l)) : o(l);
  }, o = (l) => {
    if (!e) {
      i.fire("error", {
        type: "error",
    ...
    t.timestamp = Date.now(), t.request = e(
      l,
      (a) => {
        t.duration = Date.now() - t.timestamp, t.complete = !0, a instanceof Blob && (a = Je(a, a.name || dt(l))), i.fire(
          "load",
  ...
  return (s, o, i, l, a, f) => {
    ...
    return d.onload = (m) => {
      ...
      o(
        J(
          "load",
          m.status,
          t.method === "HEAD" ? null : Je(n(m.response), T),
          h
        )
      );
    }, d.onerror = (m) => {
    ...
    }, d.ontimeout = ze(i), d.onprogress = l, d.onabort = a, d;
  };
}, Ie = {
  QUEUED: 0,
  COMPLETE: 1,
  ...
  const W = () => o(D.serverId), v = (b) => b.status === Ie.QUEUED || b.status === Ie.ERROR, B = (b) => {
    ...
    C.onload = () => {
      ...
      b.status = Ie.ERROR, b.request = null, q(b) || ze(i)($);
    }, C.onabort = () => {
  ...
  }, w.ontimeout = ze(l), w.onprogress = a, w.onabort = f, w;
}, so = (e = "", t, n, r) => typeof t == "function" ? (...s) => t(n, ...s, r) : !t || !fe(t.url) ? null : ro(e, t, n, r), lt = (e = "", t) => {
  if (typeof t == "function")
    return t;
  if (!t || !fe(t.url))
    return (s, o) => o();
...
}, Nr = (e = 0, t = 1) => e + Math.random() * (t - e), io = (e, t = 1e3, n = 0, r = 25, s = 250) => {
  let o = null;
  const i = Date.now(), l = () => {
    let a = Date.now() - i, f = Nr(r, s);
    a + f > t && (f = a + f - t);
    let d = a / t;
  ...
  const n = {
    ...
    f.fire("start"), n.timestamp = Date.now(), n.perceivedPerformanceUpdater = io(
      (p) => {
  ...
  return f;
}, Gr = (e) => e.substring(0, e.lastIndexOf(".")) || e, ao = (e) => {
  let t = [e.name, e.size, e.type];
  return e instanceof Blob || Yt(e) ? t[0] = e.name || Pr() : Yt(e) ? (t[1] = e.length, t[2] = Cr(e)) : fe(e) && (t[0] = dt(e), t[1] = 0, t[2] = "application/octet-stream"), {
    name: t[0],
    size: t[1],
    type: t[2]
  };
}, et = (e) => !!(e instanceof File || e instanceof Blob && e.name), Fr = (e) => {
  if (!ae(e))
    return e;
  const t = vt(e) ? [] : {};
  for (const n in e) {
  ...
  const i = {}, l = (v) => s.status = v, a = (v, ...B) => {
    ...
    s.file = ao(v), B.on("init", () => {
      ...
      s.activeLoader = null;
      const U = (b) => {
        s.file = et(b) ? b : s.file, e === oe.LIMBO && s.serverFileReference ? l(V.PROCESSING_COMPLETE) : l(V.IDLE), a("load");
      }, ie = (b) => {
    ...
    filenameWithoutExtension: { get: () => Gr(s.file.name) },
    fileExtension: { get: f },
    fileType: { get: d },
    fileSize: { get: m },
    file: { get: h },
  ...
  return W;
}, co = (e, t) => Pe(t) ? 0 : fe(t) ? e.findIndex((n) => n.id === t) : -1, kn = (e, t) => {
  const n = co(e, t);
  if (!(n < 0))
    return e[n] || null;
}, Vn = (e, t, n, r, s, o) => {
  ...
  return i.onload = (l) => {
    ...
    t(J("load", l.status, Je(l.response, f), a));
  }, i.onerror = (l) => {
    n(J("error", l.status, l.statusText, l.getAllResponseHeaders()));
  }, i.onheaders = (l) => {
    o(J("headers", l.status, null, l.getAllResponseHeaders()));
  }, i.ontimeout = ze(n), i.onprogress = r, i.onabort = s, i;
}, qn = (e) => (e.indexOf("//") === 0 && (e = location.protocol + e), e.toLowerCase().replace("blob:", "").replace(/([a-z])?:\/\//, "$1").split("/")[0]), uo = (e) => (e.indexOf(":") > -1 || e.indexOf("//") > -1) && qn(location.href) !== qn(e), mt = (e) => (...t) => qe(e) ? e(...t) : e, fo = (e) => !et(e.file), Bt = (e, t) => {
  ...
  MOVE_ITEM: ({ query: r, index: s }) => {
    const o = He(n.items, r);
    if (!o)
      return;
    const i = n.items.indexOf(o);
    s = wr(s, 0, n.items.length - 1), i !== s && n.items.splice(s, 0, n.items.splice(i, 1)[0]);
  },
  SORT: ({ compare: r }) => {
  ...
  ADD_ITEMS: ({ items: r, index: s, interactionMethod: o, success: i = () => {
    ...
    const f = t("GET_IGNORED_FILES"), d = (T) => et(T) ? !f.includes(T.name.toLowerCase()) : !Pe(T), h = r.filter(d).map(
      (T) => new Promise((p, I) => {
        e("ADD_ITEM", {
          interactionMethod: o,
          source: T.source || T,
  ...
  ADD_ITEM: ({
    ...
    const f = a.type === "local" ? oe.LOCAL : a.type === "limbo" ? oe.LIMBO : oe.INPUT, d = lo(
    ...
    }), $e("DID_CREATE_ITEM", d, { query: t, dispatch: e });
    const m = t("GET_ITEM_INSERT_LOCATION");
    n.options.itemInsertLocationFreedom || (s = m === "before" ? -1 : n.items.length), Yi(n.items, d, s), qe(m) && r && xt(n, m);
    const h = d.id;
    d.on("init", () => {
  ...
  COMPLETE_LOAD_ITEM: ({ item: r, data: s }) => {
    ...
    if (qe(l) && i && xt(n, l), e("DID_LOAD_ITEM", {
      id: r.id,
      error: null,
  ...
  PROCESS_ITEM: _e(n, (r, s, o) => {
    ...
    const a = () => {
      ...
      if (!d)
        return;
      const { id: m, success: h, failure: T } = d, p = He(n.items, m);
      if (!p || p.archived) {
        a();
        return;
      }
    ...
    r.onOnce("process-complete", () => {
      ...
      if (n.options.instantUpload && r.origin === oe.LOCAL && qe(d.remove)) {
        const T = () => {
        };
    ...
    r.process(
      oo(
        so(f.server.url, f.server.process, f.name, {
  ...
  REMOVE_ITEM: _e(n, (r, s, o, i) => {
    ...
    r.origin === oe.LOCAL && a && qe(a.remove) && i.remove !== !1 ? (e("DID_START_ITEM_REMOVE", { id: r.id }), a.remove(
      r.source,
      () => l(),
      (f) => {
  ...
  REVERT_ITEM_PROCESSING: _e(n, (r) => {
    r.revert(
      ...
      (n.options.instantUpload || fo(r)) && e("REMOVE_ITEM", { query: r.id });
    }).catch(() => {
    });
  }),
  SET_OPTIONS: ({ options: r }) => {
    const s = Object.keys(r), o = po.filter((l) => s.includes(l));
    [
  ...
  let o = 1;
  return s > r && s - r <= 0.5 && (o = 0), r > s && r - s >= 0.5 && (o = 0), mo(
    e,
    t,
    n,
...
}, Wn = (e, t, n) => e.toFixed(t).split(".").filter((r) => r !== "0").join(n), So = ({ root: e, props: t }) => {
  const n = Me("span");
...
}), Ur = (e) => Math.round(e * 100), yo = ({ root: e }) => {
  const t = Me("span");
  t.className = "filepond--file-status-main", e.appendChild(t), e.ref.main = t;
  const n = Me("span");
  n.className = "filepond--file-status-sub", e.appendChild(n), e.ref.sub = n, kr({ root: e, action: { progress: null } });
}, kr = ({ root: e, action: t }) => {
  const n = t.progress === null ? e.query("GET_LABEL_FILE_LOADING") : `${e.query("GET_LABEL_FILE_LOADING")} ${Ur(t.progress)}%`;
  ee(e.ref.main, n), ee(e.ref.sub, e.query("GET_LABEL_TAP_TO_CANCEL"));
}, bo = ({ root: e, action: t }) => {
  const n = t.progress === null ? e.query("GET_LABEL_FILE_PROCESSING") : `${e.query("GET_LABEL_FILE_PROCESSING")} ${Ur(t.progress)}%`;
  ee(e.ref.main, n), ee(e.ref.sub, e.query("GET_LABEL_TAP_TO_CANCEL"));
}, Oo = ({ root: e }) => {
  ...
  write: Ee({
    ...
    DID_REQUEST_ITEM_PROCESSING: Oo,
    DID_ABORT_ITEM_PROCESSING: Do,
    DID_COMPLETE_ITEM_PROCESSING: vo,
    DID_UPDATE_ITEM_PROCESS_PROGRESS: bo,
    DID_UPDATE_ITEM_LOAD_PROGRESS: kr,
...
const he = (e) => {
...
}, Lo = (e) => e.ref.buttonAbortItemLoad.rect.element.width, ht = (e) => Math.floor(e.ref.buttonRemoveItem.rect.element.height / 4), wo = (e) => Math.floor(e.ref.buttonRemoveItem.rect.element.left / 2), Po = (e) => e.query("GET_STYLE_LOAD_INDICATOR_POSITION"), Mo = (e) => e.query("GET_STYLE_PROGRESS_INDICATOR_POSITION"), Xt = (e) => e.query("GET_STYLE_BUTTON_REMOVE_ITEM_POSITION"), Co = {
  ...
  loadProgressIndicator: { opacity: 0, align: Po },
  processProgressIndicator: { opacity: 0, align: Mo },
  ...
  if (l && s && (n.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM", n.RevertItemProcessing.icon = "GET_ICON_REMOVE"), a && !s) {
    const p = Ze.DID_COMPLETE_ITEM_PROCESSING;
    p.info.translateX = wo, p.info.translateY = ht, p.status.translateY = ht, p.processingCompleteIndicator = { opacity: 1, scaleX: 1, scaleY: 1 };
  }
  if (a && !i && ([
    ...
    Ze[p].status.translateY = ht;
  }), Ze.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = Lo), f && s) {
  ...
  ), e.ref.info = e.appendChildView(e.createChildView(Ro, { id: r })), e.ref.status = e.appendChildView(e.createChildView(Ao, { id: r }));
  ...
  Bo({ root: e, actions: t, props: n });
  let r = t.concat().filter((s) => /^DID_/.test(s.type)).reverse().find((s) => Ze[s.type]);
  if (r) {
    e.ref.activeStyles = [];
    const s = Ze[r.type];
    Z(Co, (o, i) => {
  ...
  e.ref.fileName = Me("legend"), e.appendChild(e.ref.fileName), e.ref.file = e.appendChildView(e.createChildView(xo, { id: t.id })), e.ref.data = !1;
}, ko = ({ root: e, props: t }) => {
  ee(e.ref.fileName, rn(e.query("GET_ITEM_NAME", t.id)));
}, Vo = se({
  create: Uo,
  ...
  tag: "fieldset",
  name: "file-wrapper"
}), Qn = { type: "spring", damping: 0.6, mass: 7 }, qo = ({ root: e, props: t }) => {
  [
    {
      name: "top"
    },
  ...
  if ((e.ref.scalable === null || t.scalable !== e.ref.scalable) && (e.ref.scalable = Sr(t.scalable) ? t.scalable : !0, e.element.dataset.scalable = e.ref.scalable), !t.height)
    return;
  ...
  if (e.ref.handleClick = (r) => e.dispatch("DID_ACTIVATE_ITEM", { id: t.id }), e.element.id = `filepond--item-${t.id}`, e.element.addEventListener("click", e.ref.handleClick), e.ref.container = e.appendChildView(e.createChildView(Vo, { id: t.id })), e.ref.panel = e.appendChildView(e.createChildView(Vr, { name: "item-panel" })), e.ref.panel.height = null, t.markedForRemoval = !1, !e.query("GET_ALLOW_REORDER"))
    return;
  ...
  const n = (r) => {
    ...
    const i = zo(e.query("GET_ACTIVE_ITEMS"));
  ...
  ({ root: e, actions: t, props: n, shouldOptimize: r }) => {
    ...
    o ? r || (e.height = e.rect.element.width * o) : ($o({ root: e, actions: t, props: n }), !e.height && e.ref.container.rect.element.height > 0 && (e.height = e.ref.container.rect.element.height)), r && (e.ref.panel.height = null), e.ref.panel.height = e.height;
  }
), jo = se({
  create: Wo,
  write: Xo,
...
const on = (e, t, n) => {
  ...
  e.dragOffset ? (e.translateX = null, e.translateY = null, e.translateX = e.dragOrigin.x + e.dragOffset.x, e.translateY = e.dragOrigin.y + e.dragOffset.y, e.scaleX = 1.025, e.scaleY = 1.025) : (e.translateX = t, e.translateY = n, Date.now() > e.spawnDate && (e.opacity === 0 && Ko(e, t, n, r, s), e.scaleX = 1, e.scaleY = 1, e.opacity = 1));
}, Ko = (e, t, n, r, s) => {
...
}, kt = (e) => e.rect.element.height + e.rect.element.marginBottom * 0.5 + e.rect.element.marginTop * 0.5, ea = (e) => e.rect.element.width + e.rect.element.marginLeft * 0.5 + e.rect.element.marginRight * 0.5, ta = ({ root: e, action: t }) => {
  ...
  DID_REMOVE_ITEM: Jo,
  DID_DRAG_ITEM: ta
}), ra = ({ root: e, props: t, actions: n, shouldOptimize: r }) => {
  na({ root: e, props: t, actions: n });
...
}, sa = (e, t) => t.filter((n) => n.data && n.data.id ? e.id === n.data.id : !0), ia = se({
  create: Qo,
  write: ra,
  tag: "ul",
  name: "list",
  ...
  e.element.id = `filepond--browser-${t.id}`, re(e.element, "name", e.query("GET_NAME")), re(e.element, "aria-controls", `filepond--assistant-${t.id}`), re(e.element, "aria-labelledby", `filepond--drop-label-${t.id}`), qr({ root: e, action: { value: e.query("GET_ACCEPTED_FILE_TYPES") } }), Hr({ root: e, action: { value: e.query("GET_ALLOW_MULTIPLE") } }), Yr({ root: e, action: { value: e.query("GET_ALLOW_DIRECTORIES_ONLY") } }), jt({ root: e }), zr({ root: e, action: { value: e.query("GET_REQUIRED") } }), Wr({ root: e, action: { value: e.query("GET_CAPTURE_METHOD") } }), e.ref.handleChange = (n) => {
    if (!e.element.value)
      return;
    const r = Array.from(e.element.files).map((s) => (s._relativePath = s.webkitRelativePath, s));
    setTimeout(() => {
      t.onload(r), fa(e.element);
    }, 250);
  ...
  write: Ee({
    DID_LOAD_ITEM: tr,
    DID_REMOVE_ITEM: tr,
    DID_THROW_ITEM_INVALID: pa,
    DID_SET_DISABLED: jt,
    DID_SET_ALLOW_BROWSE: jt,
    DID_SET_ALLOW_DIRECTORIES_ONLY: Yr,
    DID_SET_ALLOW_MULTIPLE: Hr,
    DID_SET_ACCEPTED_FILE_TYPES: qr,
    DID_SET_CAPTURE_METHOD: Wr,
    DID_SET_REQUIRED: zr
  })
}), nr = {
  ENTER: 13,
  ...
  }, n.addEventListener("keydown", e.ref.handleKeyDown), e.element.addEventListener("click", e.ref.handleClick), $r(n, t.caption), e.appendChild(n), e.ref.label = n;
}, $r = (e, t) => {
  e.innerHTML = t;
  ...
  write: Ca,
  ignoreRect: !0
}), Ga = (e) => "getRootNode" in e ? e.getRootNode() : document, Fa = ["jpg", "jpeg", "png", "gif", "bmp", "webp", "svg", "tiff"], Ba = ["css", "csv", "html", "txt"], xa = {
  zip: "zip|compressed",
  epub: "application/epub+zip"
}, jr = (e = "") => (e = e.toLowerCase(), Fa.includes(e) ? "image/" + (e === "jpg" ? "jpeg" : e === "svg" ? "svg+xml" : e) : Ba.includes(e) ? "text/" + e : xa[e] || ""), ln = (e) => new Promise((t, n) => {
  const r = Wa(e);
  if (r.length && !Ua(e))
    return t(r);
  ka(e).then(t);
}), Ua = (e) => e.files ? e.files.length > 0 : !1, ka = (e) => new Promise((t, n) => {
  const r = (e.items ? Array.from(e.items) : []).filter((s) => Va(s)).map((s) => qa(s));
  if (!r.length) {
  ...
  if (za(e)) {
    Ha(cn(e)).then(t).catch(n);
    return;
  }
  t([e.getAsFile()]);
}), Ha = (e) => new Promise((t, n) => {
  const r = [];
  let s = 0, o = 0;
  const i = () => {
    o === 0 && s === 0 && t(r);
  ...
  if (e.type.length)
    return e;
  const t = e.lastModifiedDate, n = e.name, r = jr(Pt(e.name));
  return r.length && (e = e.slice(0, e.size, r), e.name = n, e.lastModifiedDate = t), e;
}, za = (e) => Qr(e) && (cn(e) || {}).isDirectory, Qr = (e) => "webkitGetAsEntry" in e, cn = (e) => e.webkitGetAsEntry(), Wa = (e) => {
  let t = [];
  try {
    if (t = Xa(e), t.length)
      return t;
  ...
  return s;
}, Ka = (e, t) => ("elementFromPoint" in e || (e = document), e.elementFromPoint(t.x, t.y)), un = (e, t) => {
  const n = Ga(t), r = Ka(n, {
...
const It = (e, t) => {
  ...
  n.preventDefault(), Zr = n.target, t.forEach((r) => {
    const { element: s, onenter: o } = r;
    un(n, s) && (r.state = "enter", o(We(n)));
  });
}, el = (e, t) => (n) => {
  n.preventDefault();
  ...
  ln(r).then((s) => {
    ...
    t.some((i) => {
      ...
      if (un(n, a)) {
        ...
        l && !o && It(r, "none"), i.state && (i.state = null, d(We(n)));
    });
  });
}, tl = (e, t) => (n) => {
  n.preventDefault();
  ...
  Zr === n.target && t.forEach((r) => {
    const { onexit: s } = r;
    r.state = null, s(We(n));
  });
}, rl = (e, t, n) => {
  e.classList.add("filepond--hopper");
  const { catchesDropsOnPage: r, requiresDropOnElement: s, filterItems: o = (d) => d } = n, i = ja(
    e,
...
const Ke = [], Kr = (e) => {
  ...
  ln(e.clipboardData).then((n) => {
    n.length && Ke.forEach((r) => r(n));
  });
}, sl = (e) => {
  Ke.includes(e) || (Ke.push(e), !Qt && (Qt = !0, document.addEventListener("paste", Kr)));
}, il = (e) => {
  en(Ke, Ke.indexOf(e)), Ke.length === 0 && (document.removeEventListener("paste", Kr), Qt = !1);
}, ol = () => {
  const e = (n) => {
    t.onload(n);
  }, t = {
...
const Vt = [], Ct = (e, t) => {
...
}, es = (e) => e.element.parentNode.contains(document.activeElement), cl = ({ root: e, action: t }) => {
  if (!es(e))
    return;
  e.element.textContent = "";
  const n = e.query("GET_ITEM", t.id);
  Vt.push(n.filename), clearTimeout(sr), sr = setTimeout(() => {
    Jr(e, Vt.join(", "), e.query("GET_LABEL_FILE_ADDED")), Vt.length = 0;
  }, 750);
}, ul = ({ root: e, action: t }) => {
  if (!es(e))
    return;
  const n = t.item;
  Jr(e, n.filename, e.query("GET_LABEL_FILE_REMOVED"));
}, dl = ({ root: e, action: t }) => {
  ...
  write: Ee({
    DID_LOAD_ITEM: cl,
    DID_REMOVE_ITEM: ul,
    DID_COMPLETE_ITEM_PROCESSING: dl,
  ...
  tag: "span",
  name: "assistant"
}), ts = (e, t = "-") => e.replace(new RegExp(`${t}.`, "g"), (n) => n.charAt(1).toUpperCase()), ns = (e, t = 16, n = !0) => {
...
}, El = 1e6, Ot = (e) => e.preventDefault(), pl = ({ root: e, props: t }) => {
  ...
  ), e.ref.list = e.appendChildView(e.createChildView(da, { translateY: null })), e.ref.panel = e.appendChildView(e.createChildView(Vr, { name: "panel-root" })), e.ref.assistant = e.appendChildView(e.createChildView(fl, { ...t })), e.ref.data = e.appendChildView(e.createChildView(Na, { ...t })), e.ref.measure = Me("div"), e.ref.measure.style.height = "100%", e.element.appendChild(e.ref.measure), e.ref.bounds = null, e.query("GET_STYLES").filter((a) => !Pe(a.value)).map(({ name: a, value: f }) => {
    e.element.dataset[a] = f;
  }), e.ref.widthPrevious = null, e.ref.widthUpdated = ns(() => {
...
}, ml = ({ root: e, props: t, actions: n }) => {
  if (gl({ root: e, props: t, actions: n }), n.filter((F) => /^DID_SET_STYLE_/.test(F.type)).filter((F) => !Pe(F.data.value)).map(({ type: F, data: W }) => {
    const v = ts(F.substring(8).toLowerCase(), "_");
  ...
  let r = e.ref.bounds;
  r || (r = e.ref.bounds = Il(e), e.element.removeChild(e.ref.measure), e.ref.measure = null);
  const { hopper: s, label: o, list: i, panel: l } = e.ref;
  s && s.updateHopperState();
  const a = e.query("GET_PANEL_ASPECT_RATIO"), f = e.query("GET_ALLOW_MULTIPLE"), d = e.query("GET_TOTAL_ITEMS"), m = f ? e.query("GET_MAX_FILES") || El : 1, h = d === m, T = n.find((F) => F.type === "DID_ADD_ITEM");
  if (h && T) {
  ...
  const p = hl(e), I = Tl(e), D = o.rect.element.height, O = !f || h ? 0 : D, A = h ? i.rect.element.marginTop : 0, L = d === 0 ? 0 : i.rect.element.marginBottom, w = O + A + I.visual + L, P = O + A + I.bounds + L;
  ...
  if (r && !e.ref.hopper) {
    const s = rl(
      ...
      },
      {
        filterItems: (o) => {
          ...
          return o.filter((l) => et(l) ? !i.includes(l.name.toLowerCase()) : !0);
        },
    ...
    }, e.ref.hopper = s, e.ref.drip = e.appendChildView(e.createChildView(Oa));
  } else
  ...
  r && !e.ref.paster ? (e.ref.paster = ol(), e.ref.paster.onload = (s) => {
  ...
  const p = {
    ...
    _write: (S) => {
      ...
      h && !y.length || (A(y), h = m._write(S, y, l), Li(r.query("GET_ITEMS")), h && r.processDispatchQueue());
    }
  }, I = (S) => (y) => {
    const M = {
      type: S
    ...
    const C = q();
    return y.length ? y.map((X) => Ve(X) ? C[X] ? C[X].id : null : X).filter((X) => X).map((X) => v(X, M)) : Promise.all(C.map((X) => v(X, M)));
  }, Y = {
    // supports events
    ...wt(),
...
}, yl = (e) => e.charAt(0).toLowerCase() + e.slice(1), bl = (e) => ts(e.replace(/^data-/, "")), ss = (e, t) => {
  Z(t, (n, r) => {
    Z(e, (s, o) => {
      ...
      const a = r.group;
      ae(r) && !e[a] && (e[a] = {}), e[a][yl(s.replace(i, ""))] = o;
    }), r.mapping && ss(e[r.group], r.mapping);
  });
}, Ol = (e, t = {}) => {
  const n = [];
  Z(e.attributes, (s) => {
  ...
  const r = n.filter((s) => s.name).reduce((s, o) => {
    const i = re(e, o.name);
    return s[bl(o.name)] = i === o.name ? !0 : i, s;
  }, {});
  return ss(r, t), r;
}, Dl = (e, t = {}) => {
  const n = {
  ...
  $e("SET_ATTRIBUTE_TO_OPTION_MAP", n);
  const r = {
    ...t
  }, s = Ol(
...
}, vl = (...e) => Bs(e[0]) ? Dl(...e) : rs(...e), Al = ["fire", "_read", "_write"], ur = (e) => {
  const t = {};
  return Or(e, t, Al), t;
}, Ll = (e, t) => e.replace(/(?:{([a-zA-Z]+)})/g, (n, r) => t[r]), wl = (e) => {
  ...
  const t = e({
    ...
    utils: {
      ...
      isString: fe,
      isFile: et,
      toNaturalFileSize: xr,
      replaceInString: Ll,
      getExtensionFromFilename: Pt,
      getFilenameWithoutExtension: Gr,
      ...
      applyFilterChain: Re,
      text: ee,
      getNumericAspectRatioFromString: Ar
    },
    views: {
      fileActionButton: Br
    }
  ...
  Mi(t.options);
}, Nl = () => Object.prototype.toString.call(window.operamini) === "[object OperaMini]", Gl = () => "Promise" in window, Fl = () => "slice" in Blob.prototype, Bl = () => "URL" in window && "createObjectURL" in window.URL, xl = () => "visibilityState" in document, Ul = () => "performance" in window, kl = () => "supports" in (window.CSS || {}), Vl = () => /MSIE|Trident/.test(window.navigator.userAgent), fr = (() => {
  const e = (
    // Has to be a browser
    _r() && // Can't run on Opera Mini due to lack of everything
    !Nl() && // Require these APIs to feature detect a modern browser
    xl() && Gl() && Fl() && Bl() && Ul() && // doesn't need CSSSupports but is a good way to detect Safari 9+ (we do want to support IE11 though)
    (kl() || Vl())
  );
  return () => e;
})(), Ne = {
...
let Zt = {}, Er = {}, St = Xe, qt = Xe, pr = Xe, mr = Xe, Dt = Xe, hr = Xe, Tr = Xe;
if (fr()) {
  ci(
    () => {
  ...
  }, pr = (n) => Array.from(n.querySelectorAll(`.${ql}`)).filter(
...
Yl && document.dispatchEvent(new CustomEvent("FilePond:pluginloaded", { detail: as }));
class xe {
  constructor(t) {
    if (t.dataset.refFileUpload)
      return xe.refs[t.dataset.refFileUpload];
    this.ref = Math.random(), xe.refs[this.ref] = this, t.dataset.refFileUpload = this.ref, this.inputs = t.querySelectorAll('input[type="file"]'), this.fileponds = {}, this.headers = {
      Authorization: "pFdRC99ihTG!C%BQB6EJKjc!n%"
    }, document.addEventListener("FilePond:loaded", () => this.onload());
    const n = new Be(t.closest("[c-async-form]"));
...
xe.refs = {};
window.FileUpload = xe;
document.addEventListener("DOMContentLoaded", () => {
  Array.from(document.querySelectorAll("[c-file-upload]")).forEach((e) => new xe(e));
});
const zl = {
...
function $l() {
  ...
  Zl(h), jl(h, r), Kl(h), Ql(h, i, t, l), Jl(h), ec(h, e);
...
function jl({ view: e, controller: t }, n) {
...
function Ql({ view: e, controller: t }, n, r, s) {
...
function Jl(e) {
  const t = e.view, n = e.controller, r = t.form.closest("[c-async-form]"), s = t.back, o = t.next, i = new Be(r);
  i.onState = (l) => {
